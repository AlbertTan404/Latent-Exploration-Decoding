...
#++
from led.decoding import set_global_decoding_params
#--
...
class Scheduler(
    ...
    def __init__(
        ...
        #++
        self.enable_think_only = server_args.enable_think_only
        #---
    ...
    def init_tokenizer(self):
        ...
        self.model_config = ModelConfig(
            ...
            #++
            enable_think_only=server_args.enable_think_only,
            #--
        )
    ...
    def handle_generate_request(
        ...
        if (
            ...
            req = Req(
                ...
                #++
                enable_think_only=self.enable_think_only,
                #--
            )
    ...
    def process_batch_result(
        ...
        if batch.forward_mode.is_decode():
            ...
            #++
            if self.server_args.enable_soft_thinking or self.server_args.enable_think_only:
...
def run_scheduler_process(
    ...
    #++
    if hasattr(server_args, "decoding_params") and server_args.decoding_params is not None:
        set_global_decoding_params(_decoding_params=server_args.decoding_params)
    #--
